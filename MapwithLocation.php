...
<script>
    ...
    function initMap() {
        var dehradun = {lat: 30.31829, lng: 78.0105384};
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBF6vMAOg0huhUAA8-8OpcUOnAtTFXw2zo&callback=initMap">
</script>
